      ...
      {isLoading ? (
        ...
        >
          {settings?.communityGuidelines ? (
            <Text style={styles.content}>{settings.communityGuidelines}</Text>
          ) : (
            <View style={styles.placeholder}>
              <Feather name="file-text" size={40} color={Colors.textMuted} />
              <Text style={styles.placeholderTitle}>Community guidelines coming soon</Text>
              <Text style={styles.placeholderText}>
                We're putting the finishing touches on our community guidelines. Check back soon!
              </Text>
            </View>
          )}
        </ScrollView>
