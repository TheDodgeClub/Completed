      ...
      {isLoading ? (
        ...
        >
          {settings?.privacyPolicyContent ? (
            <Text style={styles.content}>{settings.privacyPolicyContent}</Text>
          ) : (
            <View style={styles.placeholder}>
              <Feather name="shield" size={40} color={Colors.textMuted} />
              <Text style={styles.placeholderTitle}>Privacy policy coming soon</Text>
              <Text style={styles.placeholderText}>
                Our full privacy policy is being finalised. We're committed to keeping your data safe and will publish it here shortly.
              </Text>
            </View>
          )}
        </ScrollView>
